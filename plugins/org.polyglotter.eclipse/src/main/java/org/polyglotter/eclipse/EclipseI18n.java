...
public final class EclipseI18n {
    ...
    public static final I18n focusTreeRotateToolTip = new I18n( "Rotate this tree 90°" );
    ...
    public static final I18n focusTreeUnableToCreateItem = new I18n( "Unable to create item in column \"%s\": %s" );
    public static final I18n focusTreeUnableToCreateFile = new I18n( "Unable to create file in folder \"%s\": %s" );
    ...
    public static final I18n testUnableToRenameFile = new I18n( "Unable to rename\n\n\"%s\"\n\nto\n\n\"%s\"" );
}
